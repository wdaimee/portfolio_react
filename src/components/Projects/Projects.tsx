        ...
        <MainContainer>
            ...
            <ProjectContainer>
                ...
                <Card title='gUber MERN Fullstack' 
                      ...
                      description='gÜber - The Goalie Rental App is a MERN Fullstack application where users can signup to find goalies who can fill their sport games. Users can also sign up to play as a goalie and find games to fill. This Fullstack app uses a React.js Front End with a modified Back End from the Goalie Rental App RESTful API seen below. You can login with the following credentials:
                      
                      Username: user@gmail.com
                      
                      Password: User123'
                />
                <Card title="Dealish Django Fullstack" backgroundLink='https://i.imgur.com/vJEp2OW.png' />
            </ProjectContainer>
        </MainContainer>
    )
};